...
public class GmailMethods 
{
	...
	public String validateuserid(String l,String d,String c) throws Exception
	{
		try
		{
			if(c.equals("blank") && driver.findElement(By.xpath("//*[contains(text(),'Enter an email')]")).isDisplayed())
			{
			...
			else if(c.equalsIgnoreCase("invalid") && driver.findElement(By.xpath("//*[contains(test(),'find your Google')])[2]")).isDisplayed())
			{
	...
	public String validatepwd(String l,String d,String c) throws Exception
	{
		try
		{
			if(c.equalsIgnoreCase("blank") && driver.findElement(By.xpath("//*[text()='COMPOSE']")).isDisplayed())
			{
